...
var ASM_CONSTS = {
  5275968: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5276029: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5276093: function() {return Module.webglContextAttributes.powerPreference;},  
 5276151: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5276206: function($0) {performance.now = function() { return $0; };},  
 5276254: function($0) {performance.now = function() { return $0; };},  
 5276302: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _DeleteSlotFromSupabaseJS(slotNumber) {
          window.DeleteSlotFromSupabaseJS(slotNumber);
    }

  function _ForcePlayerPrefsSyncJS() {
  ...
  function _GetLocalStorage(keyPtr) {
  ...
  function _LoadAllSaveSlotsJS() {
      window.LoadAllSaveSlotsJS();
      }

  function _SaveSlotToSupabaseJS(slotNumber, usernamePtr, levelsUnlocked, currentMoney, unlockedCosmeticsPtr) {
  ...
  function _SetLocalStorage(keyPtr, valuePtr) {
       const key = UTF8ToString(keyPtr);
  ...
  function _createPlayerData(userIdPtr, emailPtr, usernamePtr) {
  ...
  function _loadPlayerData(userIdPtr) {
          const userId = UTF8ToString(userIdPtr);
  ...
  function _updatePlayerData(userIdPtr, levelsUnlocked, currentMoney, unlockedCosmeticsPtr) {
     const userId = UTF8ToString(userIdPtr);
        const unlockedCosmetics = UTF8ToString(unlockedCosmeticsPtr);
...
var asmLibraryArg = {
  "DeleteSlotFromSupabaseJS": _DeleteSlotFromSupabaseJS,
  "ForcePlayerPrefsSyncJS": _ForcePlayerPrefsSyncJS,
  "GetJSMemoryInfo": _GetJSMemoryInfo,
  "GetLocalStorage": _GetLocalStorage,
  "GetPendingSaveData": _GetPendingSaveData,
  "HasPendingSaveData": _HasPendingSaveData,
  ...
  "LoadAllSaveSlotsJS": _LoadAllSaveSlotsJS,
  "SaveSlotToSupabaseJS": _SaveSlotToSupabaseJS,
  ...
  "SupabaseGoogleSignIn": _SupabaseGoogleSignIn,
  "SupabaseLogin": _SupabaseLogin,
  "SupabaseLogout": _SupabaseLogout,
  "SupabaseRegister": _SupabaseRegister,
  ...
  "abort": _abort,
  "createPlayerData": _createPlayerData,
